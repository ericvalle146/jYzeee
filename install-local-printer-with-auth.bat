...
if not exist "local-printer-service" mkdir local-printer-service
cd local-printer-service

echo [2/4] Copiando arquivos...
copy ..\local-printer-service-with-auth.js local-printer-service.js
copy ..\local-printer-package.json package.json
